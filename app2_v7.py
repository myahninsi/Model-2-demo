...
if not os.path.exists(company_data_path):
    ...
    if st.button('Predict'):
        ...
        if data.empty:
            ...
            # Predict the market trend and price for the next day
            current_features = X_scaled[-1].reshape(1, -1)  # Last available data point
            prediction = best_classifier.predict(current_features)[0]
            ...
            # Display the next day's predicted trend and price
            ...
            # Plot the actual and predicted trend with prices
            ...
            plt.plot(future_date, next_price, marker='o', color='green' if prediction == 1 else 'red' if prediction == 0 else 'yellow', markersize=10,
